...
class rsActiveLife
{
    ...
    {
        COption::SetOptionInt("collected.activelife", "click_protection_delay", 1500 );
        COption::SetOptionInt("collected.activelife", "request_delay", 250 );
        COption::SetOptionString("collected.activelife", "show_mouse_loading", "Y" );
        COption::SetOptionString("collected.activelife", "propcode_color", "SKU_COLOR" );
        COption::SetOptionString("collected.activelife", "propcode_brands", "MAKER" );
        COption::SetOptionString("collected.activelife", "propcode_brands_img", "MAKER_LOGO" );
        COption::SetOptionString("collected.activelife", "propcode_size", "SKU_SIZE" );
        COption::SetOptionString("collected.activelife", "filter_price_view", "slider" );
        ...
        {
            COption::SetOptionString("collected.activelife", "color_table_name_".$c, $arColor["NAME"] );
            COption::SetOptionString("collected.activelife", "color_table_rgb_".$c, $arColor["RGB"] );
            $c++;
        }
    ...
    function ShowPanel()
    {
        if ($GLOBALS["USER"]->IsAdmin() && COption::GetOptionString("main", "wizard_solution", "", SITE_ID) == "collected.activelife")
        {
            $GLOBALS["APPLICATION"]->SetAdditionalCSS("/bitrix/wizards/collected/activelife/css/panel.css"); 

            $arMenu = Array(
                Array(        
                    "ACTION" => "jsUtils.Redirect([], '".CUtil::JSEscape("/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&wizardSiteID=".SITE_ID."&wizardName=collected:activelife&".bitrix_sessid_get())."')",
            ...
            $GLOBALS["APPLICATION"]->AddPanelButton(array(
                "HREF" => "/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&wizardName=collected:activelife&wizardSiteID=".SITE_ID."&".bitrix_sessid_get(),
