...
Class collected_daysarticle2 extends CModule
{
    ...
    function DoInstall()
    {
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/collected.daysarticle2/install/install.php");
    }
    ...
    function DoUninstall()
    {
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/collected.daysarticle2/install/uninstall.php");
    }
}
?>