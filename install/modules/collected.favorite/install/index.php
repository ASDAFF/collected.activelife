...
Class collected_favorite extends CModule
{
    ...
    function DoInstall()
    {
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/collected.favorite/install/install.php");
    }
    ...
    function DoUninstall()
    {
		...
		$APPLICATION->IncludeAdminFile(GetMessage("SCOM_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/collected.favorite/install/uninstall.php");
    }
}
?>