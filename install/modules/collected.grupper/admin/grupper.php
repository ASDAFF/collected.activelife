...
$sTableID = "collected_grupper_groups";
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddViewField("ID", '<a href="collected_grupper_edit.php?ID='.$f_ID.'&lang='.LANG.'">'.$f_ID.'</a>' );
	...
	$arActions[] = array(
		...
		"ACTION" => $lAdmin->ActionRedirect("collected_grupper_edit.php?ID=".$f_ID."&lang=".LANG)
	);
	$arActions[] = array(
		"ICON" => "delete",
		"DEFAULT" => false,
		"TEXT" => GetMessage("GRUPPER_ACTION_DELETE"),
		"ACTION" => "if(confirm('".GetMessage("IMYIE_ACTION_DELETE_OK")."')) ".$lAdmin->ActionRedirect("collected_grupper.php?ID=".$f_ID."&delete=Y&action=delete&lang=".LANG)
	);
...
$aContext = array(
	array(
		...
		"LINK" => "collected_grupper_edit.php?lang=".LANG,
		"TITLE" => "",
		"ICON" => "btn_new",
	),
);
