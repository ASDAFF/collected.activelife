...
/*
$iblockXMLFileOffers = "/bitrix/modules/collected.activelife/install/public/xml/".LANGUAGE_ID."/catalog_sku.xml";
if ($shopLocalization == "ua")
	$iblockXMLFilePricesOffers = "/bitrix/modules/collected.activelife/install/public/xml/".LANGUAGE_ID."/catalog_prices_sku_ua.xml";
elseif ($shopLocalization == "bl")
	$iblockXMLFilePricesOffers = "/bitrix/modules/collected.activelife/install/public/xml/".LANGUAGE_ID."/catalog_prices_sku_bl.xml";
else
	$iblockXMLFilePricesOffers = "/bitrix/modules/collected.activelife/install/public/xml/".LANGUAGE_ID."/catalog_prices_sku.xml";
*/
