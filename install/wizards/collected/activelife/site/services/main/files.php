...
if(COption::GetOptionString("collected.activelife", "wizard_installed", "N", WIZARD_SITE_ID) == "N" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	COption::SetOptionString("collected.activelife", "template_converted", "Y", "", WIZARD_SITE_ID);
}
elseif (COption::GetOptionString("collected.activelife", "template_converted", "N", WIZARD_SITE_ID) == "N")
{
	CopyDirFiles(
