...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		'COLLECT_SORT_BY_NAME' => array(0=>'sort',1=>'name',2=>'PROPERTY_PROD_PRICE_FALSE',),
		'COLLECT_SORT_BY_DEFAULT' => 'sort_asc',
		'COLLECT_OUTPUT_OF_SHOW' => 'Y',
		'COLLECT_OUTPUT_OF' => array(0=>'16',1=>'20',2=>'40',3=>'80',4=>'',),
	...
	$IS_AJAXPAGES = 'Y';
            ...
            $APPLICATION->IncludeComponent(
                ...
                Array(
                    "IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
                    "IBLOCK_ID" => $arParams["IBLOCK_ID"],
                    "ELEMENT_SORT_FIELD" => $collectCSortType,//$arParams["ELEMENT_SORT_FIELD"],
                    "ELEMENT_SORT_ORDER" => $collectCSortToo,//$arParams["ELEMENT_SORT_ORDER"],
                    ...
                    "PAGE_ELEMENT_COUNT" => $collectCOutput,//$arParams["PAGE_ELEMENT_COUNT"],
