...
class SelectSiteStep extends CSelectSiteWizardStep
{
	function InitStep()
	{
		...
		$wizard->solutionName = "collected.activelife";
	}
}
...
class SiteSettingsStep extends CSiteSettingsWizardStep
{
	function InitStep()
	{
		...
		$isWizardInstalled = COption::GetOptionString("collected.activelife", "wizard_installed", "N", $siteID) == "Y";

		if(COption::GetOptionString("collected.activelife", "wizard_installed", "N", $siteID) == "Y" && !WIZARD_INSTALL_DEMO_DATA)
		...
		$wizard->SetDefaultVars(Array(
			"siteLogo" => file_exists(WIZARD_SITE_PATH."include/logo.png") ? WIZARD_SITE_DIR."include/logo.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/activelife/site/templates/al/assets/img/logo.png"),
			"siteLogoRetina" => file_exists(WIZARD_SITE_PATH."include/logo_retina.png") ? WIZARD_SITE_DIR."include/logo_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/activelife/site/templates/al/assets/img/logo.png"),
			//"siteLogoMobile" => file_exists(WIZARD_SITE_PATH."include/logo_mobile.png") ? WIZARD_SITE_DIR."include/logo_mobile.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/activelife/site/templates/al/themes/".$themeID."/images/logo_mobile.png"),
			//"siteLogoMobileRetina" => file_exists(WIZARD_SITE_PATH."include/logo_mobile_retina.png") ? WIZARD_SITE_DIR."include/logo_mobile_retina.png" : ($isWizardInstalled ? "" : "/bitrix/wizards/collected/activelife/site/templates/al/themes/".$themeID."/images/logo_mobile_retina.png")
		));
		...
		$wizard->SetDefaultVars(
			Array(
				...
				"shopEmail" => COption::GetOptionString("collected.activelife", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"siteMetaDescription" => GetMessage("wiz_site_desc"),
				"siteMetaKeywords" => GetMessage("wiz_keywords"),
				//"installEshopApp" => COption::GetOptionString("collected.activelife", "installEshopApp", "Y", $siteID),
			)
		);
...
class CatalogSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"catalogSubscribe" => (isset($arSubscribe[$siteID])) ? ($arSubscribe[$siteID]['use'] == "Y" ? "Y" : false) : "Y",//COption::GetOptionString("collected.activelife", "catalogSubscribe", "Y", $siteID),
				"catalogView" => COption::GetOptionString("collected.activelife", "catalogView", "list", $siteID),
...
class ShopSettings extends CWizardStep
{
	function InitStep()
	{
		...
		$wizard->SetDefaultVars(
			Array(
				"shopLocalization" => COption::GetOptionString("collected.activelife", "shopLocalization", "ru", $siteID),
				"shopEmail" => COption::GetOptionString("collected.activelife", "shopEmail", "sale@".$_SERVER["SERVER_NAME"], $siteID),
				"shopOfName" => COption::GetOptionString("collected.activelife", "shopOfName", GetMessage("WIZ_SHOP_OF_NAME_DEF"), $siteID),
				"shopLocation" => COption::GetOptionString("collected.activelife", "shopLocation", GetMessage("WIZ_SHOP_LOCATION_DEF"), $siteID),
				//"shopZip" => 101000,
				"shopAdr" => COption::GetOptionString("collected.activelife", "shopAdr", GetMessage("WIZ_SHOP_ADR_DEF"), $siteID),
				"shopINN" => COption::GetOptionString("collected.activelife", "shopINN", "1234567890", $siteID),
				"shopKPP" => COption::GetOptionString("collected.activelife", "shopKPP", "123456789", $siteID),
				"shopNS" => COption::GetOptionString("collected.activelife", "shopNS", "0000 0000 0000 0000 0000", $siteID),
				"shopBANK" => COption::GetOptionString("collected.activelife", "shopBANK", GetMessage("WIZ_SHOP_BANK_DEF"), $siteID),
				"shopBANKREKV" => COption::GetOptionString("collected.activelife", "shopBANKREKV", GetMessage("WIZ_SHOP_BANKREKV_DEF"), $siteID),
				"shopKS" => COption::GetOptionString("collected.activelife", "shopKS", "30101 810 4 0000 0000225", $siteID),
				"siteStamp" => COption::GetOptionString("collected.activelife", "siteStamp", $siteStamp, $siteID),

				//"shopCompany_ua" => COption::GetOptionString("collected.activelife", "shopCompany_ua", "", $siteID),
				"shopOfName_ua" => COption::GetOptionString("collected.activelife", "shopOfName_ua", GetMessage("WIZ_SHOP_OF_NAME_DEF_UA"), $siteID),
				"shopLocation_ua" => COption::GetOptionString("collected.activelife", "shopLocation_ua", GetMessage("WIZ_SHOP_LOCATION_DEF_UA"), $siteID),
				"shopAdr_ua" => COption::GetOptionString("collected.activelife", "shopAdr_ua", GetMessage("WIZ_SHOP_ADR_DEF_UA"), $siteID),
				"shopEGRPU_ua" =>  COption::GetOptionString("collected.activelife", "shopEGRPU_ua", "", $siteID),
				"shopINN_ua" =>  COption::GetOptionString("collected.activelife", "shopINN_ua", "", $siteID),
				"shopNDS_ua" =>  COption::GetOptionString("collected.activelife", "shopNDS_ua", "", $siteID),
				"shopNS_ua" =>  COption::GetOptionString("collected.activelife", "shopNS_ua", "", $siteID),
				"shopBank_ua" =>  COption::GetOptionString("collected.activelife", "shopBank_ua", "", $siteID),
				"shopMFO_ua" =>  COption::GetOptionString("collected.activelife", "shopMFO_ua", "", $siteID),
				"shopPlace_ua" =>  COption::GetOptionString("collected.activelife", "shopPlace_ua", "", $siteID),
				"shopFIO_ua" =>  COption::GetOptionString("collected.activelife", "shopFIO_ua", "", $siteID),
				"shopTax_ua" =>  COption::GetOptionString("collected.activelife", "shopTax_ua", "", $siteID),

				"installPriceBASE" => COption::GetOptionString("collected.activelife", "installPriceBASE", "Y", $siteID),
			)
		);
	}
	...
	function InitStep()
	{
		...
		if ($shopLocalization == "ua")
			...
			$wizard->SetDefaultVars(
				Array(
					"personType" => Array(
						"fiz" =>  COption::GetOptionString("collected.activelife", "personTypeFiz", "Y", $siteID),
						"ur" => COption::GetOptionString("collected.activelife", "personTypeUr", "Y", $siteID),
					)
				)
			);
	}
...
===*/
	...
	function ShowStep()
	{
		...
		if (
			...
			LANGUAGE_ID == "ru" &&
			(
				COption::GetOptionString("collected.activelife", "wizard_installed", "N", $siteID) != "Y"
			...
			<div class="wizard-input-form-block">
				...
				<div>
					<div class="wizard-input-form-field wizard-input-form-field-checkbox">';
						...
						if(COption::GetOptionString("collected.activelife", "wizard_installed", "N", $siteID) != "Y")
						{
...
class FinishStep extends CFinishWizardStep
{
	...
	//	$this->content .= "<br clear=\"all\"><a href=\"/bitrix/admin/wizard_install.php?lang=".LANGUAGE_ID."&site_id=".$siteID."&wizardName=collected:activelife.mobile&".bitrix_sessid_get()."\" class=\"button-next\"><span id=\"next-button-caption\">".GetMessage("wizard_store_mobile")."</span></a><br>";
